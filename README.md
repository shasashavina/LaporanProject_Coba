![alt text](Laporan_Image/Cover_LP2.jpg?raw=true)
...
|  |  |
|--|--|
| ![alt text](Website_image/Home.jpg) Pada halaman pelanggan terdapat langsung halaman home yang dapat di scrolling, yang mana halaman home berisi seluruh konten seperti layanan, Product , about , Team , Lokasi dan Admin..
|  |  |
| ![alt text](Website_image/Layanan.jpg?raw=true) Pada Halaman Layanan, Pengunjung dapat melihat layanan yang di berikan oleh Seroo.
|  |  |
| ![alt text](Website_image/Product.jpg?raw=true) Pada halaman Product, Pelanggan dapat melihat Product apa saja yang di berikan oleh seroo, dengan terdapat gambar, deskripsi product dan harga Product.
|  |  |
| ![alt text](Website_image/About.jpg?raw=true) Pada halaman About, Pelanggan dapat melihat perjalanan dan Proses dari Bisnis Seroo.
|  |  |
| ![alt text](Website_image/Team.jpg?raw=true) Pada halaman Team, Pelanggan dapat melihat team Developer yang mengembangkan website dari Seroo.
|  |  |
| ![alt text](Website_image/Location.jpg?raw=true) Pada halaman Lokasi, Pelanggan dapat melihat OUTLET dari seroo, yang nantinya akan mengarahkan langsung ke maps.
